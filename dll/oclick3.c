 ...
 * 指令 oclick3_cmd.txt: "atk"=對最近怪自動點一次。
...
#define OFF_Y 0x38
#define OFF_AI 0x10
#define LOGPATH "C:\\Users\\pc\\orca\\LIN-AUTO\\dumps\\oclick3.log"
#define CMDPATH "C:\\Users\\pc\\orca\\LIN-AUTO\\dumps\\oclick3_cmd.txt"
...
static void probe(void){
 ...
 for(int i=0;i<6;i++){int cx=pts[i][0],cy=pts[i][1];SetCursorPos(o.x+cx,o.y+cy);Sleep(150);
