...
#define LOGPATH "C:\\Users\\pc\\orca\\LIN-AUTO\\dumps\\onatk23.log"
#define CMDPATH "C:\\Users\\pc\\orca\\LIN-AUTO\\dumps\\onatk23_cmd.txt"
...
#define BOWRANGE 15  /* 弓射程(格子距離 Chebyshev) — 學習得: 玩家平均在15格開打, 進此範圍就站定射不走近 */
#define MINRANGE 4   /* 最小攻擊距離(格子): 貼身(格距<此值)的怪不打, 避免近戰崩潰 */
#define VIEWRANGE 30 /* 畫面內範圍(格子) — 學習得: 玩家會打到32格外, 目標涵蓋整個畫面 */
...
static DWORD WINAPI wk(LPVOID _){(void)_;g=fopen(LOGPATH,"a");L("==== onatk23 啟動 pid=%lu ====",GetCurrentProcessId());
